...
public class HomeAdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (pageToDisplay) {
            case 0:
                mBottomNavigationView.getMenu().findItem(R.id.tab1_m).setChecked(true);
                break;
            case 1:
                mBottomNavigationView.getMenu().findItem(R.id.tab2_m).setChecked(true);
                break;
            case 2:
                mBottomNavigationView.getMenu().findItem(R.id.tab3_m).setChecked(true);
                break;
            case 3:
                mBottomNavigationView.getMenu().findItem(R.id.tab4_m).setChecked(true);
                break;
            case 4:
                mBottomNavigationView.getMenu().findItem(R.id.tab5_m).setChecked(true);
                break;
